...
function filterProperties(props, filters) {
    return props.filter((p) => {
        if (p.listingType !== 'sell') return false;
...
export default function BuyPage() {
    ...
    return (
        ...
        <h1 className="text-2xl font-bold text-gray-900">Buy Properties in India</h1>
        <p className="text-gray-500 mt-1">{filteredProperties.length}+ properties available for sale</p>
