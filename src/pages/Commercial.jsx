...
export default function CommercialPage() {
  ...
  return (
    ...
    {/* Hero Banner */}
    <div className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] py-12 px-4">
    <div className="max-w-7xl mx-auto text-center">
    <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
    <Briefcase className="w-4 h-4 text-white" />
    <span className="text-white/90 text-sm font-medium">Commercial Spaces</span>
    </div>
    <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Commercial Properties</h1>
    <p className="text-white/80 text-lg max-w-2xl mx-auto">
    Find office spaces, retail shops, co-working spaces, and warehouses for your business
    </p>
    </div>
    </div>
    ...
    <div>
    <h2 className="text-xl font-bold text-gray-900">Commercial Properties</h2>
    <p className="text-gray-500 mt-1">{filteredProperties.length}+ commercial spaces</p>
    </div>
    ...
    {filteredProperties.length === 0 ? (
      ...
      <p className="text-gray-500 text-lg">No commercial properties found matching your criteria</p>
