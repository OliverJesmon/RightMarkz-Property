...
function filterProperties(props, filters) {
  return props.filter((p) => {
    if (p.category !== 'plot') return false;
...
export default function RentPage() {
  ...
  return (
    ...
    {/* Hero Banner */}
    <div className="bg-gradient-to-br from-[#2d5016] to-[#3a6b1f] py-12 px-4">
    <div className="max-w-7xl mx-auto text-center">
    <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
    <Mountain className="w-4 h-4 text-white" />
    <span className="text-white/90 text-sm font-medium">Land & Plots</span>
    </div>
    <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Plots & Land for Sale</h1>
    <p className="text-white/80 text-lg max-w-2xl mx-auto">
    Find residential plots, commercial land, farm houses, and weekend home plots
    </p>
    </div>
    </div>
    ...
    <div>
    <h2 className="text-xl font-bold text-gray-900">Plots & Land</h2>
    <p className="text-gray-500 mt-1">{filteredProperties.length}+ plots and land available</p>
    </div>
    ...
    placeholder="Search plots and land..."
